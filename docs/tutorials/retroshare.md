...
> RetroShare 是基于 GNU Privacy Guard（GPG）构建的，好友对好友（friend-to-friend）网络之上的，用于加密文件共享、无服务器电子邮件、即时消息、在线聊天和 BBS 的开源软件。
...
进入 web 控制台 -> [I2P 隧道页面](http://127.0.0.1:7070/?page=i2p_tunnels)。查找 Server 隧道，在 “retroshare” 旁边你会看到类似于 \<很长一串字母\>.b32.i2p 的地址。
